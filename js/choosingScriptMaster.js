function showLayout1(){
		document.getElementById("layout1").setAttribute("style","display:''; ");
		document.getElementById("layout2").setAttribute("style","display: none; ");
		document.getElementById("lay1Tab").setAttribute("class"," nav-link active");
		document.getElementById("lay2Tab").setAttribute("class"," nav-link");


	}
	function showLayout2(){
		document.getElementById("layout1").setAttribute("style","display: none; ");
		document.getElementById("layout2").setAttribute("style","display:''; ");	
		document.getElementById("lay1Tab").setAttribute("class"," nav-link ");
		document.getElementById("lay2Tab").setAttribute("class"," nav-link active");
	}
...
document.addEventListener('DOMContentLoaded', function(){ 
	...
	location.href="choosingSeatMaster.php";
	...
	// checking for maximum seat //
	document.getElementById('seat').addEventListener('change', function(){
			document.getElementById('seat2').value=document.getElementById('seat').value;
	...
	document.getElementById('seat2').addEventListener('change', function(){
			document.getElementById('seat').value=document.getElementById('seat2').value;
			var max = document.getElementById('seat2').max;
		
		
	});
	document.getElementById('seatName').addEventListener('change', function(){
			var temp=document.getElementById('seatName').value;
			document.getElementById('seatName2').value=temp;
			
	});



	document.getElementById('seatName2').addEventListener('change', function(){
		document.getElementById('seatName').value=document.getElementById('seatName2').value;
 ...
 document.getElementById("lay1Tab").onclick=function(){
		showLayout1();
	}

	document.getElementById("lay2Tab").onclick=function(){
		showLayout2();
	}
...
//counter variables for each seat //	
	...
	var ch1=0; 	var ch2=0; var ch3=0; var ch4=0; var ci1=0; var ci2=0; var ci3=0; var ci4=0; 
	var ci5=0;	var cb5=0; var cc5=0; var cd5=0; var ce5=0; var cf5=0; var cg5=0; var ch5=0; 
	var c2a1=0;
